...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-96 flex flex-col sm:justify-center items-center sm:pt-0 ">
            <div>
                <a href="/">
...
<?php /**PATH C:\xampp2\htdocs\brainsterchallenges_jovanmaksimoski-fs15\forum\resources\views/layouts/guest.blade.php ENDPATH**/ ?>